<main>
  <article>
    ...
    <section class="movie-detail">
      <div class="container">
        <section class="movie-detail-banner" style="overflow:visible;">
            <div class="container">
                <video controls width="800" height="450">
                    <source src="<?= BASEURL ?>/<?= $data['series']['file_path'] ?>" type="video/mp4">
          ...
          <div class="meta-wrapper">
            ...
            <div class="date-time">
              ...
              <div>
                ...
                <time datetime="PT115M"><?= $data['series']['duration'] ?> min</time>
              </div>
            </div>
          </div>
          <p class="storyline">
