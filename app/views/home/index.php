          ...
          <ul class="movies-list">
            ...
            <li>
              <div class="movie-card">
                ...
                <a href="./movie-details.html">
                  <figure class="card-banner">
                    <img src="<?= BASEURL ?>/img/movie-1.png" alt="Sonic the Hedgehog 2 movie poster">
                  </figure>
                </a>
            ...
            <li>
              <div class="movie-card">
                ...
                <a href="./movie-details.html">
                  <figure class="card-banner">
                    <img src="<?= BASEURL ?>/img/movie-2.png" alt="Morbius movie poster">
                  </figure>
                </a>
            ...
            <li>
              <div class="movie-card">
                ...
                <a href="./movie-details.html">
                  <figure class="card-banner">
                    <img src="<?= BASEURL ?>/img/movie-3.png" alt="The Adam Project movie poster">
                  </figure>
                </a>
            ...
            <li>
              <div class="movie-card">
                ...
                <a href="./movie-details.html">
                  <figure class="card-banner">
                    <img src="<?= BASEURL ?>/img/movie-4.png" alt="Free Guy movie poster">
                  </figure>
                </a>
            ...
            <li>
              <div class="movie-card">
                ...
                <a href="./movie-details.html">
                  <figure class="card-banner">
                    <img src="<?= BASEURL ?>/img/movie-5.png" alt="The Batman movie poster">
                  </figure>
                </a>
            ...
            <li>
              <div class="movie-card">
                ...
                <a href="./movie-details.html">
                  <figure class="card-banner">
                    <img src="<?= BASEURL ?>/img/movie-6.png" alt="Uncharted movie poster">
                  </figure>
                </a>
            ...
            <li>
              <div class="movie-card">
                ...
                <a href="./movie-details.html">
                  <figure class="card-banner">
                    <img src="<?= BASEURL ?>/img/movie-7.png" alt="Death on the Nile movie poster">
                  </figure>
                </a>
            ...
            <li>
              <div class="movie-card">
                ...
                <a href="./movie-details.html">
                  <figure class="card-banner">
                    <img src="<?= BASEURL ?>/img/movie-8.png" alt="The King's Man movie poster">
                  </figure>
                </a>
          ...
          <ul class="movies-list">
            ...
            <li>
              <div class="movie-card">
                ...
                <a href="./movie-details.html">
                  <figure class="card-banner">
                    <img src="<?= BASEURL ?>/img/series-2.png" alt="Halo movie poster">
                  </figure>
                </a>
            ...
            <li>
              <div class="movie-card">
                ...
                <a href="./movie-details.html">
                  <figure class="card-banner">
                    <img src="<?= BASEURL ?>/img/series-3.png" alt="Vikings: Valhalla movie poster">
                  </figure>
                </a>
            ...
            <li>
              <div class="movie-card">
                ...
                <a href="./movie-details.html">
                  <figure class="card-banner">
                    <img src="<?= BASEURL ?>/img/series-4.png" alt="Money Heist movie poster">
                  </figure>
                </a>
