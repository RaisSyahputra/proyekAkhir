...
<body>
    <div class="container">
        <h1>Edit Movie</h1>
        <form action="<?= BASEURL ?>/home/edit/<?= $data['movie']['id_movies'] ?>" method="post" enctype="multipart/form-data">
            <input type="hidden" name="id" value="<?= $data['movie']['id_movies'] ?>">
            <div class="form-group">
                <label for="movieTitle">Movie Title</label>
                <input type="text" class="form-control" id="movieTitle" name="title" value="<?= $data['movie']['title'] ?>" placeholder="Enter movie title">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" id="releaseDate" name="release_date" value="<?= $data['movie']['release_date'] ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="duration" name="duration" value="<?= $data['movie']['duration'] ?>" placeholder="Enter duration" pattern="\d{1,11}">
            </div>

            <div class="form-group">
                <label for="synopsis">Synopsis</label>
                <textarea class="form-control" id="synopsis" name="synopsis" placeholder="Enter synopsis"><?= $data['movie']['synopsis'] ?></textarea>
            </div>
